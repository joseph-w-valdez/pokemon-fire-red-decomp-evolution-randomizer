...
const u8 gText_AllExpShareOn[] = _("The ALL EXP SHARE was\nturned ON.{PAUSE_UNTIL_PRESS}");
const u8 gText_AllExpShareOff[] = _("The ALL EXP SHARE was\nturned OFF.{PAUSE_UNTIL_PRESS}");
const u8 gText_ShinyCharmOn[] = _("The SHINY CHARM was\nturned ON.{PAUSE_UNTIL_PRESS}");
const u8 gText_ShinyCharmOff[] = _("The SHINY CHARM was\nturned OFF.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NuzlockeCantCatch[] = _("NUZLOCKE rules! You already used\nthis area's encounter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TextSpeedSlow[] = _("FAST");
const u8 gText_TextSpeedMid[] = _("FASTER");
